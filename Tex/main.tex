...
\title{Implementation and Performance Analysis of Post-Quantum Cryptography: CRYSTALS-Kyber vs. Elliptic Curve Cryptography}
\author{Hakan Keser}
\faculty{Faculty of Engineering}
\department{Computer Engineering Department}
\supervisor{Assist. Prof. Tülay Ayyıldız}
\theyear{2026}
...
\makejury{15/01/2026}{Assoc. Prof. Dr. Habil Kalkan}
